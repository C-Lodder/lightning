...
!(function(window, document){
	...
	JoomlaCalendar.prototype._create = function () {
		...
		if (this.params.showsTime) {
			...
			row.className = "time time-wrapper";

			cell = createElement("div", row);
			cell.className = "time time-title";
			cell.innerHTML = "<svg width='20' height='20' fill='var(--hiq-text-color)' viewBox='0 0 443.294 443.294' xmlns='http://www.w3.org/2000/svg'><path d='M221.647 0C99.433 0 0 99.433 0 221.647s99.433 221.647 221.647 221.647 221.647-99.433 221.647-221.647S343.861 0 221.647 0zm0 415.588c-106.941 0-193.941-87-193.941-193.941s87-193.941 193.941-193.941 193.941 87 193.941 193.941-87 193.941-193.941 193.941z'/><path d='M235.5 83.118h-27.706v144.265l87.176 87.176 19.589-19.589-79.059-79.059z'/></svg>";
	...
	JoomlaCalendar.prototype.processCalendar = function () {
		...
		if (this.params.showsTime) {
			...
			var hoursEl = this.wrapper.querySelector('.time-hours'),
				minsEl = this.wrapper.querySelector('.time-minutes');
			...
			if (!this.params.time24)
			{
				var dateAlt = new Date(this.inputField.getAttribute('data-alt-value')),
					ampmEl = this.wrapper.querySelector('.time-ampm'),
